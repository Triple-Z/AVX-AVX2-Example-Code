...
int main(int argc, char const *argv[]) {
    ...
    // 8-bit signed integer addition with saturation (AVX2)
    __m256i epi8_vec_0 = _mm256_set1_epi8(126);
    __m256i epi8_vec_1 = _mm256_set1_epi8(100);

    __m256i epi8_result = _mm256_adds_epi8(epi8_vec_0, epi8_vec_1);
    ...
    // 16-bit signed integer addition with saturation (AVX2)
    __m256i epi16_vec_0 = _mm256_set1_epi16(32766);
    __m256i epi16_vec_1 = _mm256_set1_epi16(100);

    __m256i epi16_result = _mm256_adds_epi16(epi16_vec_0, epi16_vec_1);
    ...
    // 8-bit unsigned integer addition with saturation (AVX2)
    __m256i epu8_vec_0 = _mm256_set1_epi8(254);
    __m256i epu8_vec_1 = _mm256_set1_epi8(100);

    __m256i epu8_result = _mm256_adds_epu8(epu8_vec_0, epu8_vec_1);
    ...
    // 16-bit unsigned integer addition with saturation (AVX2)
    __m256i epu16_vec_0 = _mm256_set1_epi16(65534);
    __m256i epu16_vec_1 = _mm256_set1_epi16(100);

    __m256i epu16_result = _mm256_adds_epu16(epu16_vec_0, epu16_vec_1);
