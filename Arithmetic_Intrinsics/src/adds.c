...
int main(int argc, char const *argv[]) {
    ...
    // 8-bit signed integer addition with saturation
    ...
    // 16-bit signed integer addition with saturation
    ...
    // 8-bit unsigned integer addition with saturation
    ...
    // 16-bit unsigned integer addition with saturation
