...
int main(int argc, char const *argv[]) {
    ...
    __m128 float_128_result = _mm_fnmsub_ps(float_128_vec_0, float_128_vec_1, float_128_vec_2);
    ...
    __m128d double_128_result = _mm_fnmsub_pd(double_128_vec_0, double_128_vec_1, double_128_vec_2);
    ...
    __m256 float_256_result = _mm256_fnmsub_ps(float_256_vec_0, float_256_vec_1, float_256_vec_2);
    ...
    __m256d double_256_result = _mm256_fnmsub_pd(double_256_vec_0, double_256_vec_1, double_256_vec_2);
    ...
    __m128 float_128_low_result = _mm_fnmsub_ss(float_128_vec_0, float_128_vec_1, float_128_vec_2);

    flo = (float*) &float_128_low_result;
    printf("float:\t\t%f, %f, %f, %f\n", flo[0], flo[1], flo[2], flo[3]);

    // Double-precision multiply negated and add the lowest element with 128-bit vectors (FMA)
    __m128d double_128_low_result = _mm_fnmsub_sd(double_128_vec_0, double_128_vec_1, double_128_vec_2);
