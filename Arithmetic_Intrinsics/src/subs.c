...
int main(int argc, char const *argv[]) {
    ...
    // 8-bit signed integer subtraction with saturation (AVX2)
    ...
    // 16-bit signed integer subtraction with saturation (AVX2)
    ...
    // 8-bit unsigned integer subtraction with saturation (AVX2)
    ...
    // 16-bit unsigned integer subtraction with saturation (AVX2)
